...
class CanadaNTSpider( scrapy.Spider ) :
    ...
    def parse( self, response ):
        ...
        confirmed = response.xpath( '/html/body/div/div/div[5]/main/div/div[2]/div[2]/div/div/ul[1]/li[1]/b/text()' ).get()

        negative = response.xpath( '/html/body/div/div/div[5]/main/div/div[2]/div[2]/div/div/ul[1]/li[3]/strong/text()' ).get()

        pending = response.xpath( '/html/body/div/div/div[5]/main/div/div[2]/div[2]/div/div/ul[1]/li[4]/b/text()' ).get()
