...
class NewZealandSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        positive = response.xpath( '//*[@id="node-10813"]/div[2]/div/div/table[1]/tbody/tr[3]/td[1]/b/text()' ).get()
        positive = positive.replace( ",", "" )

        total = response.xpath( '//*[@id="node-10813"]/div[2]/div/div/table[5]/tbody/tr[3]/td[2]/text()' ).get()
        total = total.replace( ",", "" )

        deaths = response.xpath( '//*[@id="node-10813"]/div[2]/div/div/table[1]/tbody/tr[6]/td[1]/text()' ).get()
